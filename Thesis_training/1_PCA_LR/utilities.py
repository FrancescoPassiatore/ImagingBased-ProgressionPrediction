    ...
    def get_patient_data(self) -> Tuple[Dict, Dict]:
        ...
        for _, row in features_df.iterrows():
            ...
            features_data[patient_id] = {
                'approx_vol': float(row['ApproxVol']),
                'avg_num_tissue_pixel': float(row['Avg_NumTissuePixel']),
                'avg_tissue': float(row['Avg_Tissue']),
                'avg_tissue_thickness': float(row['Avg_Tissue_thickness']),
                'avg_tissue_by_total': float(row['Avg_TissueByTotal']),
                'avg_tissue_by_lung': float(row['Avg_TissueByLung']),
                'mean': float(row['Mean']),
                'skew': float(row['Skew']),
