...
CONFIG = {
    ...
    "results_save_dir": Path(r"D:\FrancescoP\ImagingBased-ProgressionPrediction\Thesis_training\1_progression\results_resnet50_config_1"),
    
    # Model parameters
    'feature_dim': 2048,
    'aggregation': 'max',  # 'mean', 'max', 'attention', 'combined'
    'hidden_dims': [256,128],  # Increased capacity to avoid severe bottleneck
    'dropout': 0.7,  # Increased from 0.3 to reduce overfitting
    'use_batch_norm': True,
    
    # Training parameters
    'batch_size': 8,
    'learning_rate': 5e-4,  # Increased from 1e-5 to escape local minima
    'weight_decay': 0.05,  # Increased from 0.001 for more regularization
    'epochs': 100,
    'early_stopping_patience': 20,  # Reduced from 20 to stop earlier

    'label_smoothing': 0.2,  # Added label smoothing to prevent overconfident predictions
    'use_scheduler': True,
