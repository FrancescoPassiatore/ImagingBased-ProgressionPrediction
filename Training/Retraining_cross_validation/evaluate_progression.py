"""
Evaluate Progression Prediction from FVC@52 Predictions
========================================================

Uses the FVC@52 predictions from each approach to classify progression
...
CONFIG = {
    ...
    'plots_dir': Path(r'D:\FrancescoP\ImagingBased-ProgressionPrediction\Training\Retraining_cross_validation\plots'),
...
APPROACHES = {
    ...
    'cnn_full': 'CNN + Handcrafted + Demographics'
}
...
def main():
    print("="*80)
    print("IPF PROGRESSION PREDICTION EVALUATION")
    print("="*80)
